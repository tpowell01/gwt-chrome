 ...
 * the License.
 */
package com.chrome.gtw.client;

import com.chrome.gtw.client.events.TabAttachedEvent;
import com.chrome.gtw.client.events.TabDetachedEvent;
import com.chrome.gtw.client.events.TabEvent;
import com.chrome.gtw.client.events.TabRemovedEvent;
import com.chrome.gtw.client.events.TabSelectionChangedEvent;
import com.chrome.gtw.client.events.TabUpdatedEvent;
...
public class Tabs extends JavaScriptObject {
  ...
  public static native void create(String url, int windowId, int index,
    ...
    callback.
    @com.chrome.gtw.client.Tabs.OnTabCallback::onTab(Lcom/chrome/gtw/client/Tabs$Tab;)
    (tab);
    });
  }-*/;
  ...
  public static native void getAllInWindow(int windowId, OnTabsCallback callback) /*-{
    ...
    callback.
    @com.chrome.gtw.client.Tabs.OnTabsCallback::onTabs(Lcom/google/gwt/core/client/JsArray;)
    (tabs);
    });
  }-*/;
  ...
  public static native void update(int tabId, String url, boolean selected,
    ...
    callback.@com.chrome.gtw.client.Tabs.OnUpdateCallback::onUpdate()();
    });
  }-*/;
