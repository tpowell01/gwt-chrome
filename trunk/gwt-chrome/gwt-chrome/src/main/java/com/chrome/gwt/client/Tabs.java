...
import com.chrome.gwt.client.events.TabAttachedEvent;
import com.chrome.gwt.client.events.TabDetachedEvent;
import com.chrome.gwt.client.events.TabEvent;
import com.chrome.gwt.client.events.TabRemovedEvent;
import com.chrome.gwt.client.events.TabSelectionChangedEvent;
import com.chrome.gwt.client.events.TabUpdatedEvent;
...
public class Tabs extends JavaScriptObject {
  ...
  public static native void create(String url, int windowId, int index,
    ...
    callback.
    @com.chrome.gwt.client.Tabs.OnTabCallback::onTab(Lcom/chrome/gwt/client/Tabs$Tab;)
    (tab);
    });
  }-*/;
  ...
  public static native void getAllInWindow(int windowId, OnTabsCallback callback) /*-{
    ...
    callback.
    @com.chrome.gwt.client.Tabs.OnTabsCallback::onTabs(Lcom/google/gwt/core/client/JsArray;)
    (tabs);
    });
  }-*/;
  ...
  public static native void update(int tabId, String url, boolean selected,
    ...
    callback.@com.chrome.gwt.client.Tabs.OnUpdateCallback::onUpdate()();
    });
  }-*/;
