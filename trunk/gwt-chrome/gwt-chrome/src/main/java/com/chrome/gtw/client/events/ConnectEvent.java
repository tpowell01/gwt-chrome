 ...
 * the License.
 */
package com.chrome.gtw.client.events;

import com.chrome.gtw.client.Port;
...
public final class ConnectEvent extends Event {
  ...
  private native JavaScriptObject addListenerImpl(Listener listener) /*-{
    var handle = function(port) {
          @com.chrome.gtw.client.events.ConnectEvent::onConnectImpl(Lcom/chrome/gtw/client/events/ConnectEvent$Listener;Lcom/chrome/gtw/client/Port;)
                    (listener, port);
    }
