 ...
 * the License.
 */
package com.chrome.gtw.linker;

import com.chrome.gtw.client.BrowserAction;
import com.chrome.gtw.client.ContentScript;
import com.chrome.gtw.client.Extension;
import com.chrome.gtw.client.Icon;
import com.chrome.gtw.client.Page;
import com.chrome.gtw.client.PageAction;
import com.chrome.gtw.client.Plugin;
import com.chrome.gtw.client.ToolStrip;
import com.chrome.gtw.client.ContentScript.ManifestInfo;
...
public class ComponentGenerator extends Generator {
  private static final String BROWSERACTION_USER_TYPE = BrowserAction.class.getName();//"com.chrome.gtw.client.BrowserAction";
  private static final String CONTENTSCRIPT_USER_TYPE = ContentScript.class.getName();//"com.chrome.gtw.client.ContentScript";
  private static final String ICON_USER_TYPE = Icon.class.getName();//"com.chrome.gtw.client.Icon";
  private static final String PAGE_USER_TYPE = Page.class.getName();//"com.chrome.gtw.client.Page";
  private static final String PAGEACTION_USER_TYPE = PageAction.class.getName();//"com.chrome.gtw.client.PageAction";
  private static final String PLUGIN_USER_TYPE = Plugin.class.getName();//"com.chrome.gtw.client.Plugin";
  private static final String TOOLSTRIP_USER_TYPE = ToolStrip.class.getName();//"com.chrome.gtw.client.ToolStrip";
  ...
  private static String processBrowserAction(TreeLogger logger,
    ...
    context.commitArtifact(logger, new BrowserActionArtifact(spec.name(),
        iconFileNames.toArray(new String[0]), spec.defaultIcon(), spec.popup()));
